...
public class Partida {
	...
	/**
	 * Pensada para las dificultades medio o dificil. Construye una nueva Partida con la dificultad especificada y se crean usuarios los jugadores en base a ella.
	 * @param dificultad Dificultad que determina los parametros de la partida
	 * @see Dificultad
	 */
	...
	/**
	 * Pensada para la dificultad facil. Construye una nueva Partida con la dificultad especificada y se crean usuarios los jugadores en base a ella.
	 * @param dificultad Dificultad que determina los parametros de la partida
	 * @param cifrando Determina si el usuario estara cifrando o no, a partir de esta informacion se elige que tablero crear y como jugar
	 * @see Dificultad
	 */
	...
	/**
	 * Modo de juego en el que un usuario juega contra la maquina, introduciendo un cifrado y los aciertos de la maquina.
	 * @see Jugador
	 * @see Usuario
	 * @see IA
	 */
	...
	/**
	 * Modo de juego en el que un usuario juega contra la maquina, introduciendo un combinaciones para descubrir el cifrado de la maquina.
	 * @see Jugador
	 * @see Usuario
	 * @see IA
	 */
	...
	/**
	 * Modo de juego en el que un usuario juega contra la maquina, introduciendo un cifrado, indicando los aciertos de la maquina y descubriendo la combinacion secreta impuesta por la maquina.
	 * @see Jugador
	 * @see Usuario
	 * @see IA
	 */
	...
	/**
	 * Modo de juego en el que se enfrentan dos IA, introduciendo un cifrado, indicando los aciertos de la maquina y descubriendo la combinacion secreta impuesta por la maquina.
	 * @see Jugador
	 * @see Usuario
	 * @see IA
	 */
	public void partida_dificil() {
		...
		while (!ganador) {
			...
			if (turnoPartida == 0) {
				...
				((IA) jugador1).introducir_fila(((IA) jugador1).comb_random(jugador1.getTablero(),false));
				((IA) jugador2).introducir_aciertos(jugador1.getTablero());
				((IA) jugador2).introducir_fila(((IA) jugador2).comb_random(jugador2.getTablero(),false));
...
/*public void partida_dificil() {
	...
	/**
	 * Comparacion especifica del modo facil.Compara las ultimas combinaciones de los jugadores con sus cifrados y devuelve un numero que indica si alguno de los dos ha acertado.
	 * @param cifrando indica si en la partida el usuario esta cifrando o no
	...
	/**
	 * Comparacion para el modo medio y dificil. Compara las ultimas combinaciones de los jugadores con sus cifrados y devuelve un numero que indica si alguno de los dos ha acertado.
	 * @return 1 : si gana el usuario
	 * 		   2 : si gana la IA
	 * 		   0 : si no gana ninguno
	 * @see Jugador
	 ...
	 * @param ganador numero que indica quien es el ganador de la partida
	 */
